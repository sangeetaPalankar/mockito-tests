...
@Test
void findPreviousAppointmentByPatientIdTest() throws AppointmentServiceException {
	Appointment appointment2=new Appointment(2,"abcd","xyz","fever","14-03-2023","Accepted",1,"abcd","xyz","miss","xyz@gmail.com","10-03-2023");
	List<Appointment> appointmentList= new ArrayList<Appointment>();
	appointmentList.add(appointment2);
	when(appointmentRepository.findByPatientId(1)).thenReturn(appointmentList);
	when(appointmentRepository.findPreviousAppointmentById(1)).thenReturn(appointment2);
	when(appointmentServiceImpl.findPreviousAppointmentByPatientId(1)).thenReturn(appointment2);
	assertEquals(appointment2,appointmentServiceImpl.findPreviousAppointmentByPatientId(1));
	
}

@Test
void findPreviousAppointmentforNurseDoctor() throws AppointmentServiceException {
	Appointment appointment2=new Appointment(2,"abcd","xyz","fever","14-03-2023","Accepted",1,"abcd","xyz","miss","xyz@gmail.com","10-03-2023");
	List<Appointment> appointmentList= new ArrayList<Appointment>();
	appointmentList.add(appointment2);
	when(appointmentRepository.findByPatientId(1)).thenReturn(appointmentList);
	when(appointmentRepository.findPreviousAppointmentforNurseDoctor(1)).thenReturn(appointment2);
	when(appointmentServiceImpl.findPreviousAppointmentforNurseDoctor(1)).thenReturn(appointment2);
	assertEquals(appointment2,appointmentServiceImpl.findPreviousAppointmentforNurseDoctor(1));
	
}


@Test
public void updateByID() throws AppointmentServiceException {
	Optional<Appointment> status=Optional.of(new Appointment(2,"abcd","xyz","fever","14-03-2023","Accepted",1,"abcd","xyz","miss","xyz@gmail.com","10-03-2023"));
	when(appointmentRepository.findById(2)).thenReturn(status);
	doNothing().when(appointmentRepository).update(anyInt(),anyString());
	doNothing().when(appointmentServiceImpl).updateByID(anyInt(),anyString());

//	assertEquals(appointment2,appointmentServiceImpl.update(appointment2));

}

@Test
public void update() throws AppointmentServiceException {
	Appointment appointment2=new Appointment(2,"abcd","xyz","fever","14-03-2023","Accepted",1,"abcd","xyz","miss","xyz@gmail.com","10-03-2023");
	when(appointmentRepository.save(appointment2)).thenReturn(appointment2);
	when(appointmentServiceImpl.update(appointment2)).thenReturn(appointment2);
	assertEquals(appointment2,appointmentServiceImpl.update(appointment2));
