...
public class PhysicianAvailabilityServiceImpl implements PhysicianAvailabilityService {
	...
	public boolean setTodaysAvailbility(PhysicianAvailabiityModel physicianAvailabiity, String cstartDate,
	...
	public void setTodaysAvailbilityForAll() throws ParseException {
	...
	@Override
	public List<PhysicianAvailabiityModel> findAll() throws PhysicianAvailabilityException, ParseException {
//List<PhysicianAvailabiityModel>l=physicianAvailabilityRepository.findAll();
	...
	public PhysicianAvailabiityModel update(PhysicianAvailabiityModel physicianAvailabiity)
			throws PhysicianAvailabilityException, ParseException {
...
// TODO Auto-generated method stub
		...
		for (PhysicianAvailabiityModel physician : allPhy) {
			...
			String sDt=physician.getStartDate();
			c.setTime(sdf.parse(sDt));
			c.add(Calendar.DATE, -1);
			sDt = sdf.format(c.getTime());
			
			
			
			String eDt=physician.getEndDate();
			c.setTime(sdf.parse(eDt));
			c.add(Calendar.DATE, 1);	
			
			eDt = sdf.format(c.getTime());
			
			Date startdate = sdf.parse(sDt);
			Date enddate = sdf.parse(eDt);
