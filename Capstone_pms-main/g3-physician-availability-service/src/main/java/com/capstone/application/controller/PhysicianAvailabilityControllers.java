...
public class PhysicianAvailabilityControllers {
	...
	public ResponseEntity<List<PhysicianAvailabiityModel>> AvailablePhysician() throws PhysicianAvailabilityException, ParseException {
	...
	public List<PhysicianAvailabiityModel> AvailablePhysician1(@RequestParam boolean availability) throws PhysicianAvailabilityException, ParseException {
...
//	
	...
	public ResponseEntity<PhysicianAvailabiityModel> updatedPhysicianAvailabilitys(
			@RequestBody PhysicianAvailabiityModel physicianAvailabiity) throws PhysicianAvailabilityException, ParseException {
