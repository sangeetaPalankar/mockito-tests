...
//		patient1.setPassword("1534");
		...
		p.setContactNumber("7454529637");
		p.setDob("26-03-1999");
//		patient1.setEmail("john@gmail.com");
		p.setFirstName("John");
		p.setGender("M");
		p.setLastName("Revature");
//		patient1.setPassword("1534");
		p.setPatientId(1);
		p.setTitle("Mr");
		...
		when(patientRepo.findById(1)).thenReturn(patient);

		when(patientRepo.saveAndFlush(patient1)).thenReturn(patient1);
		patientInfoService.updatePatientById(1,p);
